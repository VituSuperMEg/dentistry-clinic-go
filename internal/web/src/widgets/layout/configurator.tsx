...
import { setFixedNavbar, setSidenavColor, setSidenavType, useMaterialTailwindController } from "@/template/context";
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between px-6 pt-8 pb-6">
        ...
        >
          <MonitorSpeaker strokeWidth={2.5} className="h-5 w-5" />
        </IconButton>
      </div>
